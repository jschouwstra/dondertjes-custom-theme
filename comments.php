...
<!--<button id="GoToReplyForm" href="#">Questions? Comments? Click here to reply now</button></br>-->

<script>
$(document).ready(function (){
    $("#GoToReplyForm").click(function (){
        $('html, body').animate({
            scrollTop: $("#CommentsAnchor").offset().top
        }, 1900);
    });
});
